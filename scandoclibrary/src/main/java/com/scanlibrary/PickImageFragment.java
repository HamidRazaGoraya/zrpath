...
public class PickImageFragment extends Fragment {
    ...
    public void openMediaContent() {
        ...
        //startGallery(true, ScanConstants.PICKFILE_REQUEST_CODE);
    }
...
/*        Intent cameraIntent = new Intent(android.provider.MediaStore.ACTION_IMAGE_CAPTURE);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            Uri tempFileUri = FileProvider.getUriForFile(getActivity().getApplicationContext(),
                    "com.scanlibrary.providerzrpath", // As defined in Manifest
                    file);
        ...
        try {
            startActivityForResult(takePictureIntent, ScanConstants.START_CAMERA_REQUEST_CODE);
    ...
    public void startGallery(boolean isSingleMode, int REQUEST_GALLERY_PRODUCT) {
        boolean returnAfterCapture = isSingleMode;
        ...
        ImagePicker imagePicker = ImagePicker.create(getActivity())
                ...
                .folderTitle("Select Image")// folder selection title
        ...
        imagePicker.limit(20) // max images can be selected (99 by default)
                ...
                .start(REQUEST_GALLERY_PRODUCT); // start image picker activity with request code
    }
