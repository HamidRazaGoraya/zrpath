...
public class Image implements Parcelable {
    ...
    public Image(long id, String name, String path, boolean isSelected, String tempProductId) {
        this.id = id;
        this.name = name;
        this.path = path;
        this.isSelected = isSelected;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.TempProductId);
    }
    ...
    protected Image(Parcel in) {
        ...
        this.TempProductId = in.readString();
    }
